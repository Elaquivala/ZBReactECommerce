            ...
            <tbody>
                {listeProduits.map((produit,index) => {
                    return <tr key={index}>
                        ...
                        <td>{produit.titre}</td>
                        <td>{produit.prix}</td>
                        <td><button className="btn btn-danger" onClick={supprimerProduit} value={produit.id}>Supprimer</button></td>
                    </tr>
                })}
            </tbody>
        </table>
        <button className="btn btn-danger" onClick={viderPanier}>Vider panier</button>
